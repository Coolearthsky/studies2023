...
public class NonholonomicCarDemo {
    ...
    static class CarControlInputs extends Inputs {
    ...
    static class Sphericalgoal implements GoalRegion {
        double radius_sqr;
        double[] center;
        int resolution;
    ...
    int main() {
        ...
        if (out.solution_found) {
            ...
            GlcLogging.nodesToFile("nonholonomic_car_demo_nodes.txt", "./", planner.partition_labels);
        }
        return 0;
    }
}
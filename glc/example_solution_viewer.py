...
#path = np.transpose(np.genfromtxt('../build/examples/pendulum_swingup_demo.txt', delimiter=','))
#nodes = np.transpose(np.genfromtxt('../build/examples/pendulum_swingup_demo_nodes.txt', delimiter=','))
#
##Plot data

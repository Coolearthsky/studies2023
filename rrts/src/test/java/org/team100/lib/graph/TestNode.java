...
public class TestNode {
    ...
    void testfoo() {
        ...
        LinkInterface link3 = Graph.newLink(root, node3, 1);
        ...
        LinkInterface link4 = Graph.newLink(root, node4, 1);
        ...
        Node node5 = new Node<>(new Matrix<>(Nat.N2(),Nat.N1(),new double[] { 1, 1 }));

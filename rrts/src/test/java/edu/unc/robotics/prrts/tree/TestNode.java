...
public class TestNode {
    ...
    void testfoo() {
        ...
        Node node3 = new Node(new double[] { 0, 1 }, 1.0, root);
        ...
        Node node4 = new Node(new double[] { 0, -1 }, 1.0, root);

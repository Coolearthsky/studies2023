...
public class EKFMultiCorrectTest {
    ...
    final ExtendedAngleEstimator<N2, N1> observer = new ExtendedAngleEstimator<N2, N1>(Nat.N2(), Nat.N1(), system,
            stateStdDevs,
    ...
    public void testMultipleSensors() {
        ...
        observer.correctVelocity(VecBuilder.fill(-0.960), system.velocity());
